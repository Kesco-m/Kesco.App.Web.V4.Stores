...
<fieldset><legend><%= Resources.Resx.GetString("STORE_StoreReportLegend")%></legend>
<table>
<tr>
...
<!--Хранитель-->
<tr>
<td><cs:Div ID="KeeperBankLabel" runat="server">:</cs:Div></td>
<td>
...
<!--Хранимый ресурс-->
<tr>
<td><cs:Div ID="ResourceLabel" runat="server">:</cs:Div></td>
<td>
...
<td>
<dbs:DBSDocument ID="sAgreement" runat="server" CSSclass="v4_resizable" NextControl="txtStoreDepartment" OnBeforeSearch="OnAgreementBeforeSearch" OnChanged="OnAgreementChanged"></dbs:DBSDocument>
</td>
</tr>

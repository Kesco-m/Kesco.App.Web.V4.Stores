...
<div class="page_content">
    ...
    <div id="SearchFilter">
        ...
        <div class="predicate_block" id="predText">
        ...
        <div class="predicate_block" id="predStore">
            <!--Список складов-->
        ...
        <div class="predicate_block" id="predValid">
        ...
        <div class="predicate_block" id="predType">
            <!--Тип склада-->
            ...
            <dbs:DBSStoreType ID="sStoreType" runat="server" MaxItemsInPopup="16" Width="200px" IsUseCondition="True"
                              IsMultiSelect="True" IsRemove="True" HasCheckbox="True" AutoSetSingleValue="True" CSSClass="aligned_control">
            </dbs:DBSStoreType>
        </div>

        <div class="predicate_block" id="predStorage">
            <!--Место хранения-->
            ...
            <dbs:DBSResidence ID="sStorage" runat="server" Width="200px" CLID="26" IsUseCondition="True" IsMultiSelect="True"
                              IsRemove="True" HasCheckbox="True" AutoSetSingleValue="True" CSSClass="aligned_control">
            </dbs:DBSResidence>
        </div>

        <div class="predicate_block" id="predName">
        ...
        <div class="predicate_block" id="predIban">
            <!--IBAN номар счета-->
        ...
        <div class="predicate_block" id="predKeeper">
            <!--Хранитель-->
            ...
            <dbs:DBSPerson ID="sKeeperBank" runat="server" Width="200px" CLID="15" IsUseCondition="True" IsAlwaysAdvancedSearch="True"
                           IsMultiSelect="True" IsRemove="True" HasCheckbox="True" IsCaller="True" CallerType="Person" AutoSetSingleValue="True" CSSClass="aligned_control">
            </dbs:DBSPerson>
        </div>

        <div class="predicate_block" id="predManager">
            <!--Распорядитель-->
        ...
        <div class="predicate_block" id="predManagerDepartment">
            ...
            <dbs:DBSPersonDepartment ID="sManagerDepartment" MaxItemsInPopup="16" runat="server" Width="200px" IsUseCondition="True"
                                     IsMultiSelect="True" IsRemove="True" HasCheckbox="True" OnBeforeSearch="OnManagerDepartmentBeforeSearch" AutoSetSingleValue="True" CSSClass="aligned_control">
            </dbs:DBSPersonDepartment>
        </div>

        <div class="predicate_block" id="predAgreement">
            <!--Договор храненния-->
            ...
            <dbs:DBSDocument ID="sAgreement" runat="server" Width="200px" IsUseCondition="True" IsMultiSelect="True"
                             IsRemove="True" HasCheckbox="True" OnBeforeSearch="OnAgreementBeforeSearch" AutoSetSingleValue="True" CSSClass="aligned_control">
            </dbs:DBSDocument>
        </div>

        <div class="predicate_block" id="predResource">
            <!--Хранимый ресурс-->
            ...
            <dbs:DBSResource ID="sResource" runat="server" Width="200px" CLID="17" IsAlwaysAdvancedSearch="true"
                             IsUseCondition="True" IsMultiSelect="True" IsRemove="True" HasCheckbox="True" OnBeforeSearch="OnResourceBeforeSearch" AutoSetSingleValue="True" CSSClass="aligned_control">
            </dbs:DBSResource>
        </div>

        <div class="predicate_block" id="predDepartment">
        ...
        <div class="predicate_block" id="predDescription">
            <!--Примечание-->
        ...
        <div>
            <!--Последняя строка условий-->
            <div class="predicate_block" id="predQuery">
    ...
    <div id="setupForm" style="display: none;">
        ...
        <div id="setupFormPredicates">
            <div>
                <input type="checkbox" id="display_Store" checked="checked"/><label for="display_Store"><%= Resources.Resx.GetString("STORE_Store") %></label>
            </div>
            <div>
                <input type="checkbox" id="display_Valid" checked="checked"/><label for="display_Valid"><%= Resources.Resx.GetString("STORE_IsActual") %></label>
            </div>
            <div>
                <input type="checkbox" id="display_Type" checked="checked"/><label for="display_Type"><%= Resources.Resx.GetString("STORE_StoreType") %></label>
            </div>
            <div>
                <input type="checkbox" id="display_Storage" checked="checked"/><label for="display_Storage"><%= Resources.Resx.GetString("STORE_Residence") %></label>
            </div>
            <div>
                <input type="checkbox" id="display_Name" checked="checked"/><label for="display_Name"><%= Resources.Resx.GetString("STORE_Name") + '/' + Resources.Resx.GetString("STORE_Account") %></label>
            </div>
            <div>
                <input type="checkbox" id="display_Iban" checked="checked"/><label for="display_Iban"><%= Resources.Resx.GetString("STORE_IBAN") %></label>
            </div>
            <div>
                <input type="checkbox" id="display_Keeper" checked="checked"/><label for="display_Keeper"><%= Resources.Resx.GetString("STORE_Keeper") + '/' + Resources.Resx.GetString("STORE_Bank") %></label>
            </div>
            <div>
                <input type="checkbox" id="display_Manager" checked="checked"/><label for="display_Manager"><%= Resources.Resx.GetString("STORE_Manager") %></label>
            </div>
            <div>
                <input type="checkbox" id="display_ManagerDepartment" checked="checked"/><label for="display_ManagerDepartment"><%= Resources.Resx.GetString("STORE_ManagerDepartment") %></label>
            </div>
            <div>
                <input type="checkbox" id="display_Agreement" checked="checked"/><label for="display_Agreement"><%= Resources.Resx.GetString("STORE_Agreement") %></label>
            </div>
            <div>
                <input type="checkbox" id="display_Resource" checked="checked"/><label for="display_Resource"><%= Resources.Resx.GetString("STORE_Resource") + '/' + Resources.Resx.GetString("STORE_Currency") %></label>
            </div>
            <div>
                <input type="checkbox" id="display_Department" checked="checked"/><label for="display_Department"><%= Resources.Resx.GetString("STORE_Department") + '/' + Resources.Resx.GetString("STORE_Branch") %></label>
            </div>
            <div>
                <input type="checkbox" id="display_Description" checked="checked"/><label for="display_Description"><%= Resources.Resx.GetString("STORE_Description") %></label>
            </div>
            <div>
                <input type="checkbox" id="display_Query" checked="checked"/><label for="display_Query"><%= Resources.Resx.GetString("STORE_Queries") %></label>
            </div>
        </div>
    </div>
